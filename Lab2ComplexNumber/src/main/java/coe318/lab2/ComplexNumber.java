...
*
* @author Abdulrehman Khan, Student#:500968727
*/
 ...
 */
    double re; // instance variables declared
    double im;
            
 public ComplexNumber(double re, double im) {
     this.re= re; //initialized the instance variables
     this.im= im;
 ...
 */
 public ComplexNumber negate() {
     ComplexNumber b = new ComplexNumber(this.re * (-1), this.im * (-1));
 return b; //A stub: to be fixed
 }
 /**
 ...
 */
 public ComplexNumber add(ComplexNumber z) {
     ComplexNumber d = new ComplexNumber(this.re + z.getReal(),this.im + z.getImaginary());
 ...
 */
 public ComplexNumber subtract(ComplexNumber z) {
     ComplexNumber e = new ComplexNumber(this.re - z.getReal(), this.im - z.getImaginary());
 ...
 */
 public ComplexNumber multiply(ComplexNumber z) {
     ComplexNumber h;
     double a, b;
     a = (this.re * z.getReal()) - (this.im * z.getImaginary());
     b = (this.re * z.getImaginary()) + (this.im * z.getReal());
     h = new ComplexNumber(a,b);
 return h; //A stub: to be fixed
 }
 /**
 ...
 */
 public ComplexNumber reciprocal() {
     ComplexNumber f, a, b;
     a = new ComplexNumber(this.re,this.im);
     b = new ComplexNumber (1,0);
     f = b.divide(a);
 return f; //A stub: to be fixed
 }
 /**
 * Returns a new ComplexNumber that is
