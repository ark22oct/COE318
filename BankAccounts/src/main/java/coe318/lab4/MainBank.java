...
*/
       ...
       public MainBank() {
           this.num=count++; }
       public void f(MainBank a, int num) {
           this.num=a.num;num=count;num++;}
       
       public static void main(String[] args)
       {MainBank a = new MainBank();MainBank b= new MainBank();a.f(b,b.num);System.out.println(a.num+a.count); }
